...
def hypothesis_final_side_by_side_html(
    ...
    *,
    ...
    parts = [
        ...
        "}",
        ".hf-row { display: flex; flex-wrap: wrap; gap: 1.35rem; align-items: flex-start; }",
        ".hf-matrix { flex: 1; min-width: 300px; }",
        ".hf-matrix table { border-collapse: collapse; width: 100%; max-width: 460px; }",
        ".hf-matrix th, .hf-matrix td {",
        "  border: 1px solid #94a3b8;",
        "  padding: 13px 15px;",
        "  text-align: center;",
        "  font-size: 1.02rem;",
        "}",
        ".hf-hdr { background: #1e293b; color: #f8fafc; font-weight: 700; }",
        ".hf-rowh { background: #334155; color: #f1f5f9; font-weight: 700; }",
        ".hf-mat-title { font-weight: 800; margin-bottom: 0.55rem; color: #0f172a; font-size: 1.08rem; }",
        ".hf-legend {",
        "  font-size: 0.96rem;",
        "  color: #334155;",
        "  margin-top: 0.95rem;",
        ...
        "Gold outline = a <strong>pure</strong> equilibrium cell for that table (neither side wants to switch alone).</p>",
        "</div>",
    ]
    return "".join(parts)
...
def joint_play_vs_hypothesis_html(
    ...
    *,
    ...
    parts: List[str] = [
        ...
        "  box-shadow: 0 1px 2px rgba(15, 23, 42, 0.06);",
        "}",
        ".jp-wrap table { border-collapse: collapse; width: 100%; max-width: 460px; }",
        ".jp-wrap th, .jp-wrap td {",
        "  border: 1px solid #94a3b8;",
        "  padding: 13px 15px;",
        "  text-align: center;",
        "  font-size: 1.02rem;",
        "}",
        ".jp-hdr { background: #1e293b; color: #f8fafc; font-weight: 700; }",
        ".jp-rowh { background: #334155; color: #f1f5f9; font-weight: 700; }",
        ".jp-title {",
        "  font-weight: 800;",
